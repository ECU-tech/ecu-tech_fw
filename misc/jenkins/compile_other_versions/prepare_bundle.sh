...
if [ -z $3 ] || [ $3 = "null" ]; then
  export FOLDER="temp/ecu-tech.snapshot.${TIMESTAMP}.${BUNDLE_NAME}"
else
  export FOLDER="temp/ecu-tech.${3}.${BUNDLE_NAME}"
fi

export BUNDLE_FULL_NAME="ecu-tech_bundle_${BUNDLE_NAME}"
